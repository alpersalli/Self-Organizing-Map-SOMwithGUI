...
namespace SOM
{
    ...
    public class Map
    {
        ...
        private static string[] clusters= new string[100];
        ...
        static void Main(string[] args)
        {
            ...
            //StreamReader sr = new StreamReader("Food.txt");
            //int lng = sr.ReadLine().Split(',').Length;
            //Console.WriteLine(lng);
            //new Map(lng - 1, 3, "Food.txt");
            DSS2019510154.Form1 form1 = new DSS2019510154.Form1(clusters);
